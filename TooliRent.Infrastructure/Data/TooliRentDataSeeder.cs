...
public static class TooliRentDataSeeder
{
    public static async Task SeedAsync(IServiceProvider services)
    {
        ...
        if (!await ctx.Members.AnyAsync(m => m.Email == "egzon@example.com"))
        {
            ...
            {
                Id = Guid.Parse("70000000-aaaa-aaaa-aaaa-700000000001"),
                FirstName = "Egzon",
                LastName = "Demo",
        ...
        if (!await ctx.Members.AnyAsync(m => m.Email == "alexander@example.com"))
        {
            ctx.Members.Add(new Member
            {
                Id = Guid.Parse("70000000-aaaa-aaaa-aaaa-700000000002"),
                FirstName = "Alexander",
                LastName = "Demo",
    ...
    private static async Task AddToolIfMissing(TooliRentDbContext ctx, Guid id, string name, string description,
        decimal pricePerDay, Guid categoryId, DateTime now, bool isAvailable = true)
    {
